                        ...
                        <div class="col-md-3 col-masonry" >
                            ...
                            <div class="product-thumb">
                                <header class="product-header">
                                    <img src="<?php echo 'admin/'.$data['image_small']; ?>" alt="<?php echo $desc; ?>" title="<?php echo $data['title']; ?>" class="centered product-image"/>
									<span class="product-label-custom label label-danger-custom">₹<?php echo $data['deal_cost']; ?></span>
                                </header>
                                <div class="product-inner centered">
									...
									<ul class="product-actions-list">
										<?php if(isset($_SESSION['user_name'])){ ?>
											<p class="product-location-custom">
