...
<head>
    <title>Kouponize - Free Localized Coupons / Actication</title>
...
if((g_iCount - 1) >= 0){
g_iCount = g_iCount - 1;
numberCountdown1.innerText = 'Redirecting you in  ' + g_iCount+ ' Seconds ........';
...
<body class="sticky-header " onLoad="startCountdown()">
	...
	////////////////////////////////////-->
		...
		<div class="container">
			<div class="gap"></div>
			<?php include("./bin/activation.php");
			echo $msg;?>	
			<h3><div id='numberCountdown1'></div> 	</h3>		
			<div class="gap"></div>
			<div class="gap"></div>
		</div>
