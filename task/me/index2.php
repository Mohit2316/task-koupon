...
<head>
	...
	<?php 
	if((!isset($_GET['selectedCity'])) AND (!isset($_COOKIE['Kouponize']))){ ?>
	<!-- added by AJ for Auto login popup 1004  -->
	<script>
	$(function() {
	$.magnificPopup.open({
		  items: {
	...
	////////////////////////////////////-->
        ...
        <div class="container">
			...
			<div class="row row-wrap">
				<div id="masonry" class="row row-wrap load_posts" >
					<?php include_once("load_posts.php");?>
				</div>
