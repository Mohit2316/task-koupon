        ...
        <section class="scrollable" id="pjax-container">
          <section class="vbox flex">
            <header class="header">
              <div class="row b-b">
                <div class="col-sm-4">
                  <h3 class="m-t m-b-none">Business Info</h3>
                  ...
                  <div class="clearfix m-t-lg m-b-sm pull-right pull-none-xs">
                    <div class="pull-left">                  
                      <div class="pull-left m-r-xs">
                        <span class="block">Merchants <span class="badge up bg-danger" data-toggle='tooltip' data-placement='bottom' data-title='Recent Merchants (3days)'>+<?php 
						echo(recent_count_of('kpn_merchant_details'));?></span></span>                    
                ...
                <section>
                  <section  class="hbox stretch">
                      ...
                      <section class="vbox">
                        <header class="header bg-light dk">
                          <ul class="nav nav-tabs">
							...
							<td align='right'>
								<form name='search_form' action='business_info.php' method='post' class="navbar-form navbar-left m-t-sm">
						...
						<?php
							if(isset($_POST['block_this'])){
								change_status_block($_POST['block_this']);
							}
					...
					if(isset($_POST['get_info'])){
						get_information($_POST['get_info']);
						}
						else{
echo "                          <div class='text-center m-b'>";
echo "                            <div class='inline'>";
echo "                              <div class='easypiechart' data-percent='65' data-line-width='25' data-track-color='#eee' data-bar-color='#afcf6f' data-scale-color='#ddd' data-loop='false' data-size='180'>";
echo "                                <span class='h2'>60</span>%";
echo "                                <div class='easypie-text'>Processing</div>";
echo "                              </div>";
echo "                            </div>";
echo "                          </div>";
echo "                          <div class='panel-group m-b' id='accordion2'>";
echo "                            <div class='panel'>";
echo "                              <div class='panel-heading'>";
echo "                                <a class='accordion-toggle' data-toggle='collapse' data-parent='#accordion2' href='#collapseOne'>";
echo "                                  Collapsible Group Item #1";
echo "                                </a>";
echo "                              </div>";
echo "                              <div id='collapseOne' class='panel-collapse in'>";
echo "                                <div class='panel-body text-sm'>";
echo "                                  Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt.";
echo "                                </div>";
echo "                              </div>";
echo "                            </div>";
echo "                            <div class='panel'>";
...
echo "                                <div class='panel-body text-sm'>";
echo "                                  Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.";
echo "                                </div>";
echo "                              </div>";
echo "                            </div>";
echo "                            <div class='panel'>";
...
echo "                                <div class='panel-body text-sm'>";
echo "                                  Sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
echo "                                </div>";
echo "                              </div>";
echo "                            </div>";
echo "                          </div>";
