        ...
        <section class="scrollable" id="pjax-container">
          <section class="vbox flex">
            <header class="header">
              <div class="row b-b">
                <div class="col-sm-4">
                  <h3 class="m-t m-b-none">User Info</h3>
                  ...
                  <div class="clearfix m-t-lg m-b-sm pull-right pull-none-xs">
                    <div class="pull-left">                  
                      <div class="pull-left m-r-xs">
                        <span class="block">Users <span class="badge up bg-danger"  data-toggle='tooltip' data-placement='bottom' data-title='Recent users (3days)'>+<?php 
						echo(recent_count_of('kpn_user_profile'));?></span></span>                    
                        <span class="h4" data-toggle='tooltip' data-placement='bottom' data-title='Total Users'><?php echo(count_of('kpn_user_profile'));?></span>
                        ...
                        <header class="header bg-light dk">
                          <ul class="nav nav-tabs">
							...
							<td width='80%' style='padding:10px 10px 10px 15px;'>
								<li class="active"><a href="#tab2" data-toggle="tab"><font size='4pt' color='gray'><strong><i class='icon-user'></i>Users</strong></font></a></li>
							</td>
							<td align='right'>
								<form name='search_form' action='user_info.php' method='post' class="navbar-form navbar-left m-t-sm">
